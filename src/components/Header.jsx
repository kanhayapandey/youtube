  ...
  return (
    ...
    >
      ...
      <div className="group flex items-center my-1 mr-7">
        <div className="flex h-8 md:h-10 md:ml-10 md:pl-5 border border-[#323131] rounded-l-3xl group-focus-within:border-blue-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0">
        ...
        <button className="w-[40px] md:w-[60px]  h-8 md:h-10 flex items-center justify-center border border-l-0 border-[#323131] rounded-r-3xl bg-white/[0.1] dark:bg-[#323131]" onClick={() => searchQueryHandler("searchButton")}>
          <IoIosSearch className="dark:text-white text-black text-xl" />
        </button>
      </div>
